...
Tunnel.prototype.updateCameraPosition = function () {
  ...
  this.mouse.position.y += (this.mouse.target.x - this.mouse.position.y) /50;
...
Tunnel.prototype.updateCurve = function () {
  ...
  for (var i = 0; i < this.tubeGeometry.vertices.length; i+=1) {
    ...
    // console.log('index is: ' + index + ', vertice.x is' + vertice.x + ', vertice.y is: ' + vertice.y);
  }
...
window.onload = function() {
  ...
  loader.load(
    "images/demo3/galaxyTexture.jpg",
    function(texture) {
