...
function Tunnel() {
  ...
  this.init();
  // create this shape of the tunnel
  this.createMesh();
...
Tunnel.prototype.init = function () {
  ...
  // Set size of renderer and its background color
  this.renderer.setSize(ww, wh);
  this.renderer.setClearColor(0x222222);

  // Create a camera and move it to along Z axis
...
Tunnel.prototype.createMesh = function () {
  ...
  // Set custom Y position for last point
  points[4].y = -0.06;

  // create a curve based on the points
  this.curve = new THREE.CatmullRomCurve3(points);
  // Define this curve type
  ...
  // Create a material for the tunnel with custom texture
  // Set side to Backside since this camera is inside the tunnel
  ...
  // Create a mesh based on the geometry and this material
  this.tubeMesh = new THREE.Mesh(this.tubeGeometry, this.tubeMaterial);
  // Push the tube into the scene
  this.scene.add(this.tubeMesh);

  // Clone this original tube geometry
  // Because we will modify this visible one but we need to keep track of the original position of the vertices
...
Tunnel.prototype.updateCurve = function () {
  ...
  for (var i = 0, j=this.tubeGeometry.vertices.length; i < j; i +=1) {
    ...
    // Caculate index of the vertice based on the z axis
  ...
  // Warn ThreeJs that spline has changed
...
var textures = {
  "stone": {
    url: 'images/demo1/stonePattern.jpg'
  },
  "stoneBump": {
    url: 'images/demo1/stonePatternBump.jpg'
  }
}

// Create a new loader
var loader = new THREE.TextureLoader();
// Prevent crossorigin issus
